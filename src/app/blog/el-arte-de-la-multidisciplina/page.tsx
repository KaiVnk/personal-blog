            ...
            <PostTemplate 
                ...
                children={
                    <>
                        ...
                        <p className="paragraph"><b>&quot;Soy un estudiante autonómo autodidacta enfocado en la multipotencialidad conjuntando diferentes disciplinas. Actua como el mejor agente especializado en el aprendizaje rapido, efectivo y profesional, recabando información de las más grandes empresas e influyentes en determinada area.
Necesito que me proporciones una ruta de estudio sobre [Habilidad], con el que obtenga conocimientos y resultados por encima de la media y haga lograr todas mis metas y propósitos en el area, pasame la respuesta siguiendo la siguiente estructura: El 20% de [Habilidad] que me dará ese 80% del dominio de la disciplina, la base fundamental de la habilidad (aquello que sí o sí debería de aprender), las herramientas y técnicas clave (aquello que te facilita aún más), y los errores comunes de tal habilidad (para evitarlos desde el principio).
Advertencia: Proporcioname una ruta de estudio que solamente priorize conocimientos importantes, NO rellenos o conocimientos que poco usaré en mi categoría de especialización.
