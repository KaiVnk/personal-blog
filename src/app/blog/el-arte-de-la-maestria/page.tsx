        ...
        <>
            ...
            >
                <>
                    ...
                    <p className="paragraph"><b>&quot;Soy un estudiante autonómo autodidacta enfocado en la maestría de disciplias conjuntas. Actua como el mejor agente especializado en el aprendizaje rapido, efectivo y profesional, recabando información de las más grandes empresas e influyentes en determinada area. Necesito que me proporciones una ruta de estudio sobre [Habilidad], con el que obtenga conocimientos y resultados increibles y muy por encima de la media, convirtiendome en un gran referente y master en la materia, pasame la respuesta siguiendo la siguiente estructura: El temario de la habilidad para convertir de [Habilidad] mi maestría (sin especificar tanto), las herramientas y técnias clave, y los errores comúnes de tal habilidad. Advertencia: Proporcioname una ruta de estudio que solamente priorize conocimientos importantes y no rellenos, siguiendo el objetivo de los grandes resultados muy por encimade la media. ¿Haz entendido lo que busco? Si necesitas información extra para pasarme un mejor resultado, no dudes en pedirlo&quot;</b></p>
